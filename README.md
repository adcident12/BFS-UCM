...
│   ├── ReportController.php             # Permission Matrix + CSV Export
...
resources/views/
    ...
    ├── dashboard.blade.php         # Stats + Charts (Chart.js)
    ...
    ├── notifications/index.blade.php             ← Notification Channels
...
# 7. Build frontend assets (Node.js ≥ 20 required on HOST)
...
| `GET` | `/audit-log` | Audit Log | Admin ทุกระดับ / SQA / QA |
