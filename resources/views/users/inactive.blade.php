...
<div class="mb-7 relative overflow-hidden rounded-2xl"
    ...
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
        <div class="absolute -top-12 -right-12 w-72 h-72 bg-rose-500/6 rounded-full blur-2xl"></div>
        <div class="absolute -bottom-16 left-24 w-56 h-56 bg-pink-400/5 rounded-full blur-2xl"></div>
    ...
    <div class="relative px-6 md:px-8 py-6 flex items-center gap-4">
        ...
        <div>
            <h2 class="text-lg font-bold text-white">ผู้ใช้ที่ไม่ได้ใช้งาน</h2>
            <p class="text-slate-400 text-xs font-medium mt-0.5">รายการผู้ใช้ที่ไม่มีกิจกรรมเกินระยะเวลาที่กำหนด</p>
        </div>
    </div>
</div>
